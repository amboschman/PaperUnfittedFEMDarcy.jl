module FIG8_1_h_convergence_on_a_cut_square

#======================================================================# 
#   FIG 8.1 :   h-convergence test on a cut square using Γ = Γₚ        #
#======================================================================#
#= 
This script reproduces the h-convergence results on a cut square using Γ = Γₚ as shown in Figure 8.1 of the paper. The used parameter settings are further detailed in the comments. To run the h-convergence test, the user has to select (i) the level of mesh refinement, (ii) the ratio h_cut/h and (iii) the relevant stabilisation parameters. 
=#
